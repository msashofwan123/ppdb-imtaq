...
<div class="form-group {{ $errors->has('presence') ? 'has-error' : ''}}">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="presence" id="presence" value="{{ isset($presence->presence) ? $presence->presence : 'Hadir'}}">
        <label class="form-check-label" for="presence">Hadir</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="presence" id="presence" value="{{ isset($presence->presence) ? $presence->presence : 'Sakit'}}">
        <label class="form-check-label" for="presence">Sakit</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="presence" id="presence" value="{{ isset($presence->presence) ? $presence->presence : 'Izin'}}">
        <label class="form-check-label" for="presence">Izin</label>
    </div>
